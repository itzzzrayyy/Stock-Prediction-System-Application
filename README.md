...
You can find the project here: https://github.com/itzzzrayyy/Stock-Prediction-System-Application
)
...
```bash
  git clone https://github.com/itzzzrayyy/Stock-Prediction-System-Application.git
```
